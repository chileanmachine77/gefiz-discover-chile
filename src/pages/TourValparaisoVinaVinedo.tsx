              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground-muted leading-relaxed">
                    Cancelación gratuita hasta 48 horas antes del tour. Cancelaciones con menos de 48 horas 
                ...
                <div>
                  ...
                  <ul className="text-foreground-muted space-y-2">
                    <li>• La degustación de vinos está permitida solo para mayores de 18 años</li>
                    <li>• Se requiere un mínimo de 4 personas para confirmar el tour</li>
              ...
              <div className="bg-background-alt rounded-xl p-6 shadow-lg">
                <div className="text-center mb-6">
                  ...
                  <div className="flex items-center justify-center space-x-1 mt-2">
                    ...
                    <span className="text-sm text-foreground-muted ml-2">(4.9/5)</span>
                  </div>
                </div>
