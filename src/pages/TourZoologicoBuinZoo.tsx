          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-card border border-card-border rounded-xl p-6 sticky top-8">
              <div className="text-center mb-6">
                ...
                <div className="text-sm text-foreground-muted mt-1">Incluye transporte, guía, entrada al zoo, safari africano, aviario tropical, espectáculo de aves, seguro de viaje</div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="08:30">08:30 - Salida Estándar</option>
                  </select>
                </div>
