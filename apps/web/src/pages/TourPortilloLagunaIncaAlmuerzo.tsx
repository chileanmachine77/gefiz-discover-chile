          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-card border border-card-border rounded-xl p-6 sticky top-8">
              <div className="text-center mb-6">
                <div className="text-3xl font-bold text-primary mb-2">CLP 95.000</div>
                <div className="text-foreground-muted">por persona</div>
                <div className="text-sm text-foreground-muted mt-1">Incluye transporte, visitas guiadas y almuerzo gourmet</div>
              </div>
            ...
            <div className="bg-background-alt rounded-xl p-4 mt-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-foreground-muted">Duración: 12 horas</span>
                </div>
                <div className="flex items-center space-x-2">
