            ...
            <section className="mt-12 mb-8">
              <div className="text-center mb-6">
                ...
                <div className="space-y-2">
                  <div className="text-xl font-semibold text-foreground">
                    Adulto: <span className="text-primary">CLP 139.000</span>
                  </div>
                  <div className="text-lg text-foreground-muted">
                    Niños: <span className="text-primary">CLP 139.000</span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-muted">15:30 hrs aproximadamente</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-muted">La actividad está sujeta a condiciones climáticas</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card border border-card-border rounded-lg p-6 space-y-4 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <span className="text-foreground-muted">Equipo (botas/bastones/tabla de esquí)</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <span className="text-foreground-muted">Clases principiante</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <span className="text-foreground-muted">Entrada a actividades de Parque Farellones</span>
                  </div>
                </div>
              </div>
