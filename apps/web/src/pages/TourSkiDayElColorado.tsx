...
const TourSkiDayElColorado = () => {
  ...
  const tourImages = [
    { src: '/images/tours/ski-day-el-colorado/colorado-1.jpg', alt: 'Ski Day El Colorado - Sillas de esquí', title: 'Sillas de Esquí' },
    { src: '/images/tours/ski-day-el-colorado/colorado-2.jpg', alt: 'Ski Day El Colorado - Pistas de esquí', title: 'Pistas de Esquí' }
  ];

  const tourDescription = "Disfruta de un día completo de esquí en El Colorado, uno de los centros de esquí más accesibles y populares de Chile. Con pistas para todos los niveles, desde principiantes hasta expertos, este tour ofrece la experiencia perfecta de deportes de invierno en la Cordillera de Los Andes. Incluye transporte, equipo de esquí y clases para principiantes. Ideal para familias y grupos que buscan aventura en la nieve con la comodidad de estar cerca de Santiago.";

  const tourHighlights = [
    "Centro de esquí El Colorado con pistas para todos los niveles",
    "Equipo de esquí completo incluido (esquís, botas, bastones)",
    "Clases de esquí para principiantes con instructor certificado",
    "Pistas variadas desde principiante hasta experto",
    "Almuerzo en restaurante de montaña",
    "Transporte cómodo desde Santiago",
    "Paisajes andinos espectaculares",
    "Experiencia de esquí accesible y familiar"
  ];
  ...
  const itinerary = [
    {
      ...
      description: "Recogida en hotel y traslado hacia El Colorado"
    },
    {
      time: "09:00",
      activity: "Llegada a El Colorado",
      description: "Llegada al centro de esquí y registro"
    },
    {
      time: "09:30",
    ...
    },
    {
      ...
      description: "Clases para principiantes con instructor certificado"
    },
    {
      time: "12:00",
      activity: "Esquí Libre",
      description: "Tiempo libre para esquiar en las pistas según nivel"
    },
    {
      time: "13:00",
      activity: "Almuerzo en Montaña",
      description: "Almuerzo en restaurante del centro de esquí"
    },
    {
      time: "14:30",
      activity: "Esquí Libre",
      description: "Continuación del esquí libre hasta el final del día"
    },
    {
      time: "16:30",
  ...
  const includedServices = [
    ...
    "Ticket de acceso al centro de esquí El Colorado",
    "Equipo completo de esquí (esquís, botas, bastones, casco)",
    "Clases de esquí para principiantes (2 horas)",
    "Almuerzo en restaurante de montaña",
    "Guía especializado en deportes de invierno",
  ...
  const recommendations = [
    {
      title: "Ropa de Esquí",
      description: "Ropa térmica, pantalón y chaqueta impermeable, guantes"
    },
    {
      title: "Calzado Cómodo",
      description: "Zapatos cómodos para caminar, las botas de esquí se proporcionan"
    },
    {
      title: "Protección Solar",
      description: "Bloqueador solar factor 30+, lentes de sol - reflejo de la nieve"
    },
    {
      title: "Nivel de Esquí",
      description: "Apto para todos los niveles, clases incluidas para principiantes"
    }
  ];
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Hola, me gustaría reservar el Ski Day El Colorado:
...
*Tour:* Ski Day El Colorado
*Duración:* 7 horas
*Incluye:* Transporte, equipo de esquí completo, clases, almuerzo
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url(/images/tours/ski-day-el-colorado/colorado-2.jpg)' }}
        >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-6 text-white/90 max-w-3xl mx-auto text-balance">
            Día completo de esquí en uno de los centros más populares de Chile
          </p>
            ...
            <section className="mt-12 mb-8">
              <div className="text-center mb-6">
                ...
                <div className="space-y-2">
                  <div className="text-xl font-semibold text-foreground">
                    Adulto: <span className="text-primary">CLP 142.000</span>
                  </div>
                  <div className="text-lg text-foreground-muted">
                    Niños: <span className="text-primary">CLP 142.000</span>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-muted">desde 06:00 hrs</p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Clock className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
              ...
              <div className="bg-card border border-card-border rounded-lg p-6 space-y-4 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <span className="text-foreground-muted">Equipo (botas/bastones/ tabla de esquí o snowboard) + clases regulares</span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <span className="text-foreground-muted">Ticket de andarivel principiante</span>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-background-alt rounded-xl p-4 mt-6">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-foreground-muted">El Colorado</span>
                </div>
                <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-foreground-muted">Clases incluidas</span>
                </div>
              </div>
            </div>
          </div>
...
export default TourSkiDayElColorado;
