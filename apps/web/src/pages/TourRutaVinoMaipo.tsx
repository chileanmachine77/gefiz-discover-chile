...
const TourRutaVinoMaipo = () => {
  ...
  const tourImages = [
    {
      src: '/images/tours/ruta-vino-valle-maipo/maipo-1.jpg',
      alt: 'Viñedos del Valle del Maipo',
      title: 'Viñedos del Maipo'
    },
    {
      src: '/images/tours/ruta-vino-valle-maipo/maipo-2.jpg',
      alt: 'Paisajes del Valle del Maipo',
      title: 'Paisajes Vinícolas'
    },
    {
      src: '/images/tours/ruta-vino-valle-maipo/maipo-3.jpg',
      alt: 'Viña boutique del Valle del Maipo',
      title: 'Viña Boutique'
    },
    {
      src: '/images/tours/ruta-vino-valle-maipo/maipo-4.jpg',
      alt: 'Cata de vinos en el Valle del Maipo',
      title: 'Cata de Vinos'
    }
  ];

  const tourHighlights = [
    "Ruta completa por el prestigioso Valle del Maipo",
    "Visita a 3 viñas boutique en un solo día",
    "Degustación de más de 12 vinos diferentes",
    "Almuerzo gourmet con maridaje en viña premium",
    "Recorrido por paisajes vinícolas únicos",
    "Cata dirigida por sommelier especializado",
    "Transporte premium con guía especializado",
    "Experiencia completa del terroir del Maipo"
  ];
  ...
  const itinerary = [
    {
      ...
      description: "Recogida en hotel y inicio de la Ruta del Vino Maipo"
    },
    {
      time: "09:30",
      activity: "Primera Viña Boutique",
      description: "Visita y degustación en viña familiar del Alto Maipo"
    },
    {
      time: "11:30",
      activity: "Segunda Viña Premium",
      description: "Recorrido por viñedos y cata de vinos reserva"
    },
    {
      time: "13:00",
      activity: "Almuerzo Gourmet",
      description: "Almuerzo con maridaje en viña con vista panorámica"
    },
    {
      time: "15:00",
      activity: "Tercera Viña Histórica",
      description: "Visita a viña centenaria y degustación especial"
    },
    {
      time: "16:30",
      activity: "Cata Final Comparativa",
      description: "Degustación comparativa de los mejores vinos del día"
    },
    {
      time: "17:30",
  ...
  const includedServices = [
    ...
    "Guía especializado en enología del Maipo",
    "Visita a 3 viñas boutique del Valle del Maipo",
    "Degustación de más de 12 vinos premium",
    "Almuerzo gourmet con maridaje incluido",
    "Cata comparativa dirigida por sommelier",
    "Material educativo sobre el Valle del Maipo",
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url(/images/tours/ruta-vino-valle-maipo/maipo-4.jpg)' }}
        >
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl mb-6 text-white/90 max-w-3xl mx-auto text-balance">
            Descubre el corazón vinícola de Chile en el Valle del Maipo
          </p>
            ...
            <section>
              ...
              <div className="prose prose-lg max-w-none text-foreground-muted">
                <p className="text-lg leading-relaxed mb-4">
                  La Ruta del Vino Maipo es una experiencia completa que te lleva por el corazón 
                  vinícola de Chile. El Valle del Maipo, reconocido mundialmente por sus vinos 
                  tintos de alta calidad, especialmente Cabernet Sauvignon, ofrece paisajes 
                  espectaculares y una tradición vinícola de más de 150 años.
                </p>
                <p className="leading-relaxed mb-4">
                  Durante esta ruta visitarás tres viñas boutique cuidadosamente seleccionadas, 
                  cada una con su propia personalidad y especialidad. Desde viñas familiares 
                  tradicionales hasta bodegas modernas de vanguardia, experimentarás la diversidad 
                  y riqueza del terroir del Maipo.
                </p>
                <p className="leading-relaxed">
                  Esta experiencia premium incluye degustaciones comparativas, almuerzo gourmet 
                  con maridaje y la oportunidad de comprender por qué el Valle del Maipo es 
                  considerado la cuna del vino chileno de calidad mundial.
                </p>
              </div>
            </section>
            ...
            <section className="mt-12 mb-8">
              <div className="text-center mb-6">
                ...
                <div className="space-y-2">
                  <div className="text-xl font-semibold text-foreground">
                    Adulto: <span className="text-primary">CLP 137.000</span>
                  </div>
                  <div className="text-lg text-foreground-muted">
                    Niños: <span className="text-primary">CLP 96.000</span>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-foreground-muted">Martes y jueves (Mínimo 2 pasajeros)</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-card border border-card-border rounded-lg p-6 space-y-4 mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-start space-x-3">
                    <Check className="w-5 h-5 text-primary mt-1 flex-shrink-0" />
                    <span className="text-foreground-muted">Degustación de vino en 2 viñedos: Viña Santa Rita y Viña Haras de Pirque (sujeto a disponibilidad de cupos. Por si acaso no esté disponible, se modificará por otra viña)</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-background-alt rounded-xl p-4 mt-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-foreground-muted">Duración: 9 horas</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <MapPin className="w-4 h-4 text-primary" />
                    <span className="text-foreground-muted">Ubicación: Valle del Maipo</span>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-foreground-muted">12+ degustaciones</span>
                  </div>
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-foreground-muted">3 viñas boutique</span>
                  </div>
                </div>
              </div>
            </div>
...
export default TourRutaVinoMaipo;
